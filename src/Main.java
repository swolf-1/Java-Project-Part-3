...
public class Main {
	...
	public static void main(String[] args) {
		...
		//Dimiourgia mia listas me ipoptous gia na thn perasoume sthn dimiourgia twn Frame
		ArrayList<Suspect> suspectsList = registry.getSuspectsList();

		//Dimiourgia antikimenou FindSuspectFrame gia na emfanistei to prwto parathiro
		new FindSuspectFrame(suspectsList,registry);
